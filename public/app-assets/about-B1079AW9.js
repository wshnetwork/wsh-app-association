import{r as at,j as ne,c as uc}from"./client-C9yhCDaK.js";import{H as hc}from"./Header-NXqATtY0.js";import{F as fc}from"./Footer-CLuUfIuX.js";/* empty css             */const Mo=at.createContext(null);function dc({children:i}){const e=at.useRef(null),t=at.useRef(!1),n=at.useCallback(s=>{!t.current&&s||s!==e.current&&(e.current=s)},[]),r={overrideRef:e,poseSettledRef:t,setOverrideImage:n};return ne.jsx(Mo.Provider,{value:r,children:i})}function mr(){const i=at.useContext(Mo);if(!i)throw new Error("usePhoneOverride must be used within a PhoneOverrideProvider");return i}/**
 * @license
